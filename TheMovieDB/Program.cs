...
namespace TheMovieDB
{
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            var connectionString = builder.Configuration.GetConnectionString("CloudConnection") ?? throw new InvalidOperationException("Connection string 'LocalConnection' not found.");
